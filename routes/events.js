...
const AUTHENTICATED_FUNNEL_EVENTS = new Set(['account_created', 'quote_started', 'quote_saved', 'quote_sent', 'quote_downloaded', 'checkout_started', 'signup_screen_viewed', 'signup_attempted', 'signup_failed']);
